        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="fas fa-edit"></i> Form Data Pasien</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('kader.pasien.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a href="{{ route('kader.pasien.index') }}" class="btn btn-secondary">
